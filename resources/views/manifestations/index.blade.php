...
@section('content')
    ...
    @if($manifestation->ANNEEFESTIVAL == 2021)
                    <div class="mt-6 ml-3 border-l-4 border-t-4 border-red-600 md:transition md:duration-5000 md:ease-in md:delay-150 md:transform md:hover:-translate-y-1 md:hover:scale-110 ">
