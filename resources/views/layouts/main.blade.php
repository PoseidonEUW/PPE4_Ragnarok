        ...
        <div class="sm:flex sm:mt-8">
            <div class="lg:mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between ">
                <div class="container flex flex-col text-center">
                    ...
                    <li class="md:my-2"><a href="/manifestations" class="text-md hover:text-red-600">Programmation</a></li>
                    <li class="md:my-2"><a href="/artistes" class="text-md hover:text-red-600">Artistes</a></li>
                    <li class="md:my-2"><a href="https://www.ville-carantec.com/" class="text-md hover:text-red-600">Ville de Carantec</a></li>
                    </div>
                </div>
            </div>
        </div>
